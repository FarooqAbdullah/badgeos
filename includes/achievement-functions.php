 ...
 */
function badgeos_open_badge_issue_badge( $user_id, $achievement_id ) {
	
	$GLOBALS['open_badge']->bake_user_badge( $user_id, $achievement_id );
	
}
add_action( 'badgeos_award_achievement', 'badgeos_open_badge_issue_badge', 10, 2 );
